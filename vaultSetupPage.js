...
class VaultSetupPage extends BasePage {
  constructor(driver) {
    super(driver);
  }
  ...
  async copyKeyToClipboardAndValidate() {
    ...
    const mnemonicElement = await this.driver.$("XCUIElementTypeTextView");
  ...
  async enterName(name) {
    const textField = await this.driver.$("XCUIElementTypeTextField");
